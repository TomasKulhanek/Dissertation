...
\documentclass[10pt,a5paper,oneside]{extbook}
...
\DeclareCaseLangs{USenglish}%  american,british,canadian,english,australian,newzealand,USenglish,UKenglish}
...
\include{abstractauto}
\addcontentsline{toc}{chapter}{Abstract}
\include{abstractenauto}
...
\include{chapter1auto} %intro
\include{chapter2auto} %hypothesis
\include{chapter3auto} %methods
\include{chapter4auto} %results
\include{chapter5auto} %discussion

\endgroup

\include{chapter6auto} %conclusion
